...
var citiesData = require('cities.json/cities.json'); // Update 'package-name' with the actual package name
// Initialize Prisma client
var prisma = new PrismaClient();
// Define function to push data to the database
function pushCitiesToDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, citiesData_1, cityData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, 6, 8]);
                    _i = 0, citiesData_1 = citiesData;
                    _a.label = 1;
                case 1:
                    if (!(_i < citiesData_1.length)) return [3 /*break*/, 4];
                    cityData = citiesData_1[_i];
